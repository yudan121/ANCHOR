...
DEFAULT_RUN_NAME = 'anchor_bmmc_partial_label_mode_v2'
DEFAULT_RESULTS_DIR = REPRODUCE_DIR / "results" / "v2"
TEACHER_OVERRIDES = {'hard_ref_sampling_correct_weight': 1.0, 'hard_ref_sampling_max_wrong_fraction': 0.3, 'hard_ref_sampling_wrong_weight': 10.0, 'n_samples_per_label': 100, 'round0_epochs': 20, 'round1_epochs': 10, 'round2_epochs': 10}
STUDENT_OVERRIDES = {'max_epochs': 100, 'rank_loss_weight': 1.0, 'safety_guard_fallback_to_teacher_round2': True}
SELECTION_OVERRIDES = {}
RHO_OVERRIDES = {}
